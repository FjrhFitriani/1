...
module.exports = {
    ...
    show_edit: function (req, res) {
        var out;
        var data = req.param('cuti_id');
        Cuti.findOne(data).exec(function (err, cuti) {
    ...
    update: function (req, res) {
        ...
        Cuti.update({ id: id }, update_data).exec(function (err, cuti) {
            if (typeof (err) != 'undefined') {
                out = {
                    status: true,
                    msg: 'Cuti telah di up'
                };
                sails.sockets.broadcast('global', 'cuti_update', out)
                res.send(out);
            }
        });
    },
    ...
    export: function (req, res) {
        ...
        worksheet.addRow(['Nama Pegawai', 'Posisi Pegawai', 'Mulai Cuti', 'Lama Cuti']);
        ...
        Cuti.find().populate(['posisi']).exec(function (err, cuti) {
            ...
            cuti.forEach(function (val, key) {
                worksheet.addRow([val.pegawai_name, val.posisi.posisi_name, val.mulai, val.lama]);
