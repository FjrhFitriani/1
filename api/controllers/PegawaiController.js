...
module.exports = {
	index: function (req, res) {
		...
		Kota.find().exec(function (err, kotas) {
			Posisi.find().exec(function (err, posisis) {
				Status.find().exec(function (err, statuss) {
	...
	update: function (req, res) {
		...
		if (req.param('name') !== '' && req.param('telp') !== '' && req.param('gender') !== '' && req.param('status_name') !== '') {
	...
	export: function (req, res) {
		...
		worksheet.addRow(['ID Pegawai', 'Nama Pegawai', 'Kontak Pegawai', 'Jenis Kelamin', 'Posisi', 'Kota', 'Status']);
		...
		Pegawai.find().populate(['kota', 'posisi']).exec(function (err, pegawai) {
			...
			pegawai.forEach(function (val, key) {
				worksheet.addRow([val.id, val.name, val.telp, val.gender, val.posisi.posisi_name, val.kota.kota_name, val.status.status_name]);
